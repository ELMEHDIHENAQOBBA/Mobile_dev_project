...
class _MyBookingsPageState extends ConsumerState<MyBookingsPage> {
  ...
  void initState() {
    super.initState();
    Future.microtask(() => ref.read(bookingNotifierProvider.notifier).loadMyBookings());
  }
  ...
  Widget _buildBody(BuildContext context, BookingState state) {
    ...
    if (state.bookings.isEmpty) {
      return Center(
        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          const Text('Find a guide and book your first tour!',
    ...
    return ListView.builder(
      ...
      itemBuilder: (_, i) => _BookingCard(
        ...
        onPay: () => context.push(Routes.payment, extra: state.bookings[i]),
        onReview: () => context.push(Routes.review, extra: state.bookings[i]),
        onCancel: () => _showCancelDialog(context, state.bookings[i]),
      ),
    );
  }
      ...
      child: Column(children: [
        Container(
          ...
          child: Row(children: [
            ...
            Text(booking.status,
                style:
                    TextStyle(color: _color, fontWeight: FontWeight.bold, fontSize: 13)),
            const Spacer(),
        ...
        Padding(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Row(children: [
              CircleAvatar(
                  radius: 24,
                  backgroundImage: booking.guideProfileImage.isNotEmpty
                      ? NetworkImage(booking.guideProfileImage)
                      : null,
                  child:
                      booking.guideProfileImage.isEmpty ? const Icon(Icons.person) : null),
            ...
            if (booking.specialRequest != null &&
              ...
              const SizedBox(height: 8),
              Text('Note: ${booking.specialRequest}',
                  style: const TextStyle(
